...
for run,year in enumerate(np.arange(2000,2017+1-train_years)):
    ...
    X_train,Y_train, X_valid,Y_valid = data_processing(input_file,ChSh_Coeff_file,input_times_freq,input_variables,target_variables,train_dates_range,train_locations,val_arg=True)
