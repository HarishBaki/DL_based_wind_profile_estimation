...
X_train,Y_train = data_processing_Heligoland(input_file,ChSh_Coeff_file,input_variables,target_variables,train_times,train_locations)
X_valid,Y_valid = data_processing_Heligoland(input_file,ChSh_Coeff_file,input_variables,target_variables,valid_times,train_locations)
